...
from axiomm import axiom, app, config, db, lang, userbot
from axiomm.helpers import format_exception, meval


@app.on_message(filters.command(["eval", "exec", "axiom", "baby", "bbu"]) & filters.user(app.owner))
@app.on_edited_message(filters.command(["eval", "exec", "axiom", "baby", "bbu"]) & filters.user(app.owner))
@lang.language()
