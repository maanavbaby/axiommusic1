...
from axiomm import app, config, db, lang, queue, thumb
from axiomm.helpers import Track, buttons


@app.on_message(filters.command(["queue", "playing","q"]) & filters.group & ~app.bl_users)
@lang.language()
