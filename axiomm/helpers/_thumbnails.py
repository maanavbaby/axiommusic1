...
from axiomm import config
from axiomm.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("axiomm/helpers/Raleway-Bold.ttf", 30)
        self.font2 = ImageFont.truetype("axiomm/helpers/Inter-Light.ttf", 30)
